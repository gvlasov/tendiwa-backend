...
/**
 * Checks if with this criteria a Seer can see cell {endX:endY} from neighbor cells of that cells (i.e. cells from 8
 ...
 * @return true if cell is visible from its neighbor, false otherwise. What neighbor is it being seen from is determined
