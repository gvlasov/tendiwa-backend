...
import org.tendiwa.core.settlements.Settlement.RoadSystem.Road;
...
/**
 * A special ammunitionType of {@link org.tendiwa.core.Location} that has advanced instruments for placing {@link org.tendiwa.core.Building}s.
 * @author suseika
 *
 */
public class Settlement extends Location {
	...
	public Service createService(org.tendiwa.core.Character dweller, int type, String name) {
	...
	public class RoadSystem {
		...
		public class Road {
			public final EnhancedPoint start;
			protected final EnhancedPoint end;
