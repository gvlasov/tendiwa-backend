...
/**
 * Defines an infinite line that goes between two rows or columns of cells. Because line is infinite and may only have
 * one of two directions, it is only defined by direction and one coordinate.
 *
 * @param direction
 * 	Horizontal or vertical.
 * @param constantCoord
 * 	If direction is vertical, then constant coord is the coordinate of cells to the right of the line. If direction is
 * 	horizontal, then coord is the coordinate of cells to the bottom of the line. That is, minimum possible coord for a
