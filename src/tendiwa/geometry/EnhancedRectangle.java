...
public class EnhancedRectangle extends Rectangle implements Placeable {
    ...
    /**
     * Creates a new rectangle whose center is the given point, with given width and height. If the rectangle created
     * has even width/height, the exact center coordinate will be randomized between two possible coordinates.
     *
     * @param point
     * @param width
     * @param height
    ...
    /**
     * Returns a Coordinate of Rectangle's middle point. If {@link EnhancedRectangle} has odd width or height,
     * Coordinate will be rounded up.
     *
     * @return
     */
