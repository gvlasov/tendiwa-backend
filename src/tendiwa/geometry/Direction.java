...
public interface Direction {
	...
	/**
	 * Returns a direction that is counterclockwise from this direction, e.g for N returns
	 * NE.
	 * 
	 * @return CardinalDirection or OrdinalDirection enums instance.
	 */
	...
	/**
	 * Same as calling direction.clockwise().clockwise(), where the resulting
	 * direction will be one quarter of full circle clockwise from initial
	 * direction.
	 * 
	 */
	public Direction clockwiseQuarter();
	/**
	 * Same as calling direction.counterClockwise().counterClockwise(), where
	 * the resulting direction will be one quarter of full circle
	 * counterclockwise from initial direction.
	 * 
	 */
