 ...
 * {@link Orientation#VERTICAL}, then {x;y} is its top cell. If direction is {@link Orientation#HORIZONTAL}, then {x;y}
...
/**
 * Returns a new {@link Range} object from this segment's start dynamic coord to its end dynamic coord.
 *
