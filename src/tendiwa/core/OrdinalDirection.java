...
/**
 * <p> Returns an int corresponding to SideTest. </p> <ul> <li>1 is {@link OrdinalDirection#NE}</li> <li>3 is {@link
 * OrdinalDirection#SE}</li> <li>5 is {@link OrdinalDirection#SW}</li> <li>7 is {@link OrdinalDirection#NW}</li> </ul>
 *
