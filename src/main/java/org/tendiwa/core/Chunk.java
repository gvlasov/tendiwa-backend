...
public class Chunk implements Serializable {
	...
	/**
	 * Returns a hash of 2 numbers: x and y coordinates in a coordinate system where maximum value of {@code y} is
	 * {@code
	 * height-1}.
	 *
	 * @param x
	 ...
	 * extracted from one integer, which is a hash of those two (no two pairs of x and y coordinates share the same
	 * hash).
	 *
	 * @param hash
