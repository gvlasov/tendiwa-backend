...
public enum CardinalDirection implements Direction {
	 ...
	 *
	 * @return Returns true if this is {@link CardinalDirection#E} or {@link CardinalDirection#W}, otherwise returns
	 * false.
	 */
	...
	public CardinalDirection left() {
		return counterClockwiseQuarter();
	}

	public CardinalDirection right() {
		return clockwiseQuarter();
	}
}
