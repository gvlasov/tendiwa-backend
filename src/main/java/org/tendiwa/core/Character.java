...
/* Getters */
	 ...
	 * <p>
	 * Note that this is not a character action, this method is also called when character blinks, being pushed and so
	 * on.
	 ...
	 * @param projectile
	 * 	An item being propelled with a ranged weapon. A UniqueItem or the whole ItemPile. You don't need to extract one
	 * 	item
	...
	/**
	 * Checks if there are any conditions that make current existing of this character dangerous. This method is
	 * supposed to
