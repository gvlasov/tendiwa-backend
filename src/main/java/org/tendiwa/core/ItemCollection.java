...
public class ItemCollection implements Iterable<Item> {
	 ...
	 * ItemType#isStackable()}, then one piece will be extracted from that pile, removing that pile in case
	 * that was the last piece.</p><p>If {@code item}'s {@link ItemType} is not {@link ItemType#isStackable()},
