...
public interface Direction {
	...
	/**
	 * Same as calling direction.clockwise().clockwise(), where the resulting direction will be one quarter of full
	 * circle
	...
	/**
	 * Same as calling direction.counterClockwise().counterClockwise(), where the resulting direction will be one
	 * quarter
