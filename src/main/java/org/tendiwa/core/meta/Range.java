...
/**
 * Returns how much integers occur in both Ranges. Unlike {@link Range#intersection(Range)} it returns an integer, so if
...
/**
 * Returns the amount of numbers in this Range. For example, for Range(7,9) it returns 3, since there are 3 numbers in
 * it: 7, 8 and 9.
 *
 * @return
 */
...
/**
 * <p> Takes {@code ranges} out of this Range and returns ranges that form the remaining set of integer values. </p> <p>
 * For example, if we split range [0,10] with ranges [2,5] and [7,8], we will get ranges [0,1], [6,6] and [9,10]. </p>
 *
 * @param ranges
