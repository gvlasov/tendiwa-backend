 ...
 * rectangle will gradually be placed tiles that contain certain placeable entities. They will head to the middle of
 * the
...
public class TerrainTransition {
	...
	public static class TerrainTransitionBuilder {
		...
		/**
		 * <p>Sets condition on which a column of cells (from border to center) stops growing and placing algorithm
		 * continues
		 * on placing next column.</p> <p>If you don't use this method on builder, the default condition will be
		 * used</p>
		 *
		 * @param condition
