...
public final class BasicBisector implements Bisector {
	private final Vector2D vector;
	private final boolean isReflex;

	public BasicBisector(Vector2D cw, Vector2D ccw) {
		if (cw.isZero()) {
	 ...
	 * @see BasicBisector#Bisector(org.tendiwa.geometry.Vector2D,
