    ...
    public void draw() {
        final GraphConstructor<Point2D, DefaultEdge> constructor =
                GraphConstructor.<Point2D>createDefault()
                        ...
                        .vertex(1, new Point2D(30, 50)).withEdgesTo(2)
                        .vertex(2, new Point2D(70, 55)).withEdgesTo(4, 7)
                        .vertex(3, new Point2D(15, 90)).withEdgesTo(1)
                        .vertex(4, new Point2D(85, 90)).withEdgesTo(3, 5)
                        .vertex(5, new Point2D(50, 70)).withEdgesTo(6)
                        .vertex(6, new Point2D(35, 80))
                        .vertex(7, new Point2D(100, 50)).withEdgesTo(11)
                        .vertex(8, new Point2D(100, 70)).withEdgesTo(9)
                        .vertex(9, new Point2D(90, 110)).withEdgesTo(10)
                        .vertex(10, new Point2D(110, 109)).withEdgesTo(8)
                        .vertex(11, new Point2D(120, 55)).withEdgesTo(12, 13)
                        .vertex(12, new Point2D(125, 90)).withEdgesTo(13, 20)
                        .vertex(13, new Point2D(150, 50)).withEdgesTo(18)
                        .vertex(14, new Point2D(180, 120)).withEdgesTo(15)
                        .vertex(15, new Point2D(200, 100)).withEdgesTo(16)
                        .vertex(16, new Point2D(220, 110))
                        .vertex(17, new Point2D(160, 75))
                        .vertex(18, new Point2D(190, 70)).withEdgesTo(19)
                        .vertex(19, new Point2D(220, 50)).withEdgesTo(20, 21)
                        .vertex(20, new Point2D(230, 85)).withEdgesTo(21, 22, 24)
                        .vertex(21, new Point2D(240, 40))
                        .vertex(22, new Point2D(230, 130)).withEdgesTo(23)
                        .vertex(23, new Point2D(300, 130)).withEdgesTo(24)
                        .vertex(24, new Point2D(300, 85))
                        .vertex(25, new Point2D(265, 90)).withEdgesTo(26, 27)
                        .vertex(26, new Point2D(250, 110)).withEdgesTo(27)
